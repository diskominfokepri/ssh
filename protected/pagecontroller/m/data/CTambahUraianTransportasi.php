...
class CTambahUraianTransportasi extends MainPageM {       
    ...
    public function saveData ($sender,$param) {
        if ($this->IsValid) {
            ...
            $str = "INSERT INTO uraian SET rekening='$no_rekening',pesawat_kelas='$txtHargaPesawatKelas',pesawat_ekonomi='$txtHargaPesawatEkonomi',kapal_kelas='$txtHargaKapalKelas',kapal_ekonomi='$txtHargaKapalEkonomi',ta=$ta,date_added=NOW(),date_modified=NOW()";
            $this->DB->insertRecord($str);
            
            $this->Pengguna->insertNewActivity($this->Page->getPagePath(),"Menambah uraian transportasi baru dengan Rekening  ($no_rekening) telah berhasil dilakukan");
            
            $this->redirect('data.TambahUraianTransportasi', true);
        }
    }
    public function lanjutInput($sender,$param) {
        if ($this->IsValid) {
            $no_rek5=$sender->Text;
            $this->redirect('data.TambahUraianTransportasi', true,array('id'=>$no_rek5));   
        }
    }
}