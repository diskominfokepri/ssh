...
class CMyprofiles extends MainPageM {    
	public function onLoad($param) {		
		parent::onLoad($param);		
        $this->showProfiles=true;        
		if (!$this->IsPostBack&&!$this->IsCallBack) {	
            if (!isset($_SESSION['currentPageCache'])||$_SESSION['currentPageCache']['page_name']!='m.settings.Myprofiles') {
				$_SESSION['currentPageCache']=array('page_name'=>'m.settings.Myprofiles','page_num'=>0);												
			}
            $this->populateData();
		}
	}
