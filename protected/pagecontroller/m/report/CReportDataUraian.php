...
class CReportDataUraian extends MainPageM {	
    public $result=array();		
	public function onLoad ($param) {		
        ...
        if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPageReportDataUraian'])||$_SESSION['currentPageReportDataUraian']['page_name']!='m.report.ReportDataUraian') {
                $_SESSION['currentPageReportDataUraian']=array('page_name'=>'m.report.ReportDataUraian','page_num'=>0,'rek1'=>'none');                                                
            }  
            try {
