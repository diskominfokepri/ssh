...
class CRincian extends MainPageD {	
	public function onLoad ($param) {
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPageRincian'])||$_SESSION['currentPageRincian']['page_name']!='d.dmaster.Rincian') {
                $_SESSION['currentPageRincian']=array('page_name'=>'d.dmaster.Rincian','page_num'=>0,'search'=>false,'no_rek3'=>'none');												
			}
