...
class CJenis extends MainPageD {	
	public function onLoad ($param) {
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPageJenis'])||$_SESSION['currentPageJenis']['page_name']!='d.dmaster.Jenis') {
                $_SESSION['currentPageJenis']=array('page_name'=>'d.dmaster.Jenis','page_num'=>0);												
			}
			$this->populateData ();		
		}
	}
