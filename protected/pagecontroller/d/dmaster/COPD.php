...
class COPD extends MainPageD {	
	public function onLoad ($param) {
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {		
            if (!isset($_SESSION['currentPageOPD'])||$_SESSION['currentPageOPD']['page_name']!='d.dmaster.OPD') {
                $_SESSION['currentPageOPD']=array('page_name'=>'d.dmaster.OPD','page_num'=>0);												
			}
			$this->populateData ();
		}
	}
