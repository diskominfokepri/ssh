...
class CSatuan extends MainPageD {	
	public function onLoad ($param) {
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {		
            if (!isset($_SESSION['currentPageSatuan'])||$_SESSION['currentPageSatuan']['page_name']!='d.dmaster.Satuan') {
                $_SESSION['currentPageSatuan']=array('page_name'=>'d.dmaster.Satuan','page_num'=>0);												
			}
			$this->populateData ();
		}
	}
