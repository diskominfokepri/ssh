...
class CObjekTransportasi extends MainPageD {    
    public function onLoad ($param) {
        ...
        if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPageObjekTransportasi'])||$_SESSION['currentPageObjekTransportasi']['page_name']!='d.dmaster.ObjekTransportasi') {
                $_SESSION['currentPageObjekTransportasi']=array('page_name'=>'d.dmaster.ObjekTransportasi','page_num'=>0,'search'=>false,'no_rek4'=>'none');                                                
            }
