...
class CKelompok extends MainPageD {	
	public function onLoad ($param) {
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {		
            if (!isset($_SESSION['currentPageKelompok'])||$_SESSION['currentPageKelompok']['page_name']!='d.dmaster.Kelompok') {
                $_SESSION['currentPageKelompok']=array('page_name'=>'d.dmaster.Kelompok','page_num'=>0);												
			}			
            $this->populateData ();
		}
	}
