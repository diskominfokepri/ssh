...
class CUsulanTransportasi extends MainPageD {
	public function onLoad ($param) {		
		...
		if (!$this->IsCallback&&!$this->IsPostBack) {    
            if (!isset($_SESSION['currentPageUsulanTransportasi'])||$_SESSION['currentPageUsulanTransportasi']['page_name']!='d.data.UsulanTransportasi') {
                $_SESSION['currentPageUsulanTransportasi']=array('page_name'=>'d.data.UsulanTransportasi','page_num'=>0,'search'=>false);												
            } 
    ...
    protected function populateData($search=false) {	        
        ...
        if ($search) {
            ...
            $str_jumlah="usulan us,unit un,v_rekening WHERE rek5.no_rek5=us.rekening AND us.ta=$tahun AND rek5.id_tipe=2";
           ...
           $str = "SELECT us.idusulan,us.rekening,rek5.nama_rek5,rek5.merek,rek5.id_satuan,us.pesawat_kelas,us.pesawat_ekonomi,us.kapal_kelas,us.kapal_ekonomi, us.status, un.nama_unit FROM usulan us, unit un, v_rekening rek5 WHERE rek5.no_rek5=us.rekening AND us.ta=$tahun AND us.idunit='$idunit' AND rek5.id_tipe=2 AND un.idunit=us.idunit";    
