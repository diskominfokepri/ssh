...
class CTambahUsulan extends MainPageD {       
                   ...
                   $no_rek5=addslashes($this->request['id']);
                    ...
                    $r=$this->DB->getRecord($str); 
                     if (isset($r[1])) {
                        ...
                        $this->lblAddKodeNamaUsulan->Text=$data['no_rek5'].' / '.$data['nama_rek5'];
    ...
    public function saveData ($sender,$param) {
        if ($this->IsValid) {
            ...
            $str = "INSERT INTO usulan SET idunit='$idunit', rekening='$no_rekening',batam='$txtHargaBatam',bintan='$txtHargaBintan',tanjungpinang='$txtHargaTanjungpinang',karimun='$txtHargaKarimun',lingga='$txtHargaLingga',natuna='$txtHargaNatuna',anambas='$txtHargaAnambas',ta=$ta,date_added=NOW(),date_modified=NOW()";
            $this->DB->insertRecord($str);
            
            $this->Pengguna->insertNewActivity($this->Page->getPagePath(),"Menambah usulan baru dengan Rekening  ($no_rekening) telah berhasil dilakukan");
