...
class CUraianTransportasi extends MainPageD {
	public function onLoad ($param) {		
		parent::onLoad ($param);	
        $this->createObj('DMaster');
        $this->showDataUraianTransportasi=true;
		if (!$this->IsCallback&&!$this->IsPostBack) {    
            if (!isset($_SESSION['currentPageUraianTransportasi'])||$_SESSION['currentPageUraianTransportasi']['page_name']!='d.data.UraianTransportasi') {
                $_SESSION['currentPageUraianTransportasi']=array('page_name'=>'d.data.UraianTransportasi','page_num'=>0,'search'=>false);												
            } 
