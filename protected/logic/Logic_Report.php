...
class Logic_Report extends Logic_Global {	
    ...
    * digunakan untuk mendapatkan data uraian   
    */  
    private function getDataUraianTransaksi ($objDMaster) {     
        $ta=$this->dataReport['ta'];
        $no_rek1=$this->dataReport['no_rek1'];
    ...
    */
     ...
     * digunakan untuk mencetak Data Uraian Barang/Peralatan
     */
    public function printDataUraianTransportasi ($objDMaster) {
        $datauraian=$this->dataReport; 
        $no_rek1=$datauraian['no_rek1'];
        $ta=$datauraian['ta'];
        switch ($this->getDriver()) {
            ...
            case 'excel2007' :    
                ...
                $sheet->duplicateStyle($styleArray, "A$row:K$row_merge");
                ...
                $sheet->setCellValue("H$row",'PESAWAT');
                $sheet->mergeCells("J$row:K$row");
                $sheet->setCellValue("J$row",'KAPAL');
                $row+=1;
                $sheet->setCellValue("H$row",'KELAS');
                $sheet->setCellValue("I$row",'EKONOMI');
                $sheet->setCellValue("J$row",'KELAS');
                $sheet->setCellValue("K$row",'EKONOMI');
                ...
                $dataproyek=$this->getDataUraianTransaksi($objDMaster);           
                $tingkat = $this->getRekeningUraian();
                                                    ...
                                                    if (preg_match("/^$k3/", $k4)) {                                                                                                        
                                                        ...
                                                        foreach ($tingkat_5 as $k5=>$v5) {
                                                            if (preg_match("/^$k4/", $k5)) {                                                              
                                                                ...
                                                                $merek=$dataproyek[$k5]['merek'];
                                                                $satuan=$dataproyek[$k5]['satuan'];
                                                                $pesawat_kelas=$objDMaster->formatUang($dataproyek[$k5]['pesawat_kelas']);
                                                                $pesawat_ekonomi=$objDMaster->formatUang($dataproyek[$k5]['pesawat_ekonomi']);
                                                                $kapal_kelas=$objDMaster->formatUang($dataproyek[$k5]['kapal_kelas']);
                                                                $kapal_ekonomi=$objDMaster->formatUang($dataproyek[$k5]['kapal_ekonomi']);
                                                                ...
                                                                $sheet->setCellValue("F$row",$v5);
                                                                $sheet->setCellValue("G$row",$satuan);
                                                                $sheet->setCellValue("H$row",$pesawat_kelas);
                                                                $sheet->setCellValue("I$row",$pesawat_ekonomi);
                                                                $sheet->setCellValue("J$row",$kapal_kelas);
                                                                $sheet->setCellValue("K$row",$kapal_ekonomi);
                                                                $row=$row+1;  
                ...
                $row=$row-1;
                 ...
                 $sheet->duplicateStyle($styleArray2, "A6:K$row");
        ...
        $this->setLink($this->dataReport['linkoutput'],"Daftar Harga Transportasi");
    }
}